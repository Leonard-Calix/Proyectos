        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Informe</h4>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title m-b-0">Informe Mayorista</h5>
                </div>
                <table class="table">
                  <thead>
                    <tr>
                      <th scope="col">Codigo_Comercio</th>
                      <th scope="col">Porcentaje_Mayorista</th>
                      <th scope="col">Zona_Comercio</th>
                      <th scope="col">Tipo_Comercio</th>
                    </tr>
                  </thead>
                  <tbody id="tabla-mayorista" >
              ...
              <div class="container-fluid">
               <div class="row">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h5 class="card-title m-b-0">Informe Minoristas</h5>
                    </div>
                    <table class="table">
                      <thead>
                        <tr>
                          <th scope="col">Codigo_Comercio</th>
                          <th scope="col">Pago_Minorista</th>
                          <th scope="col">Zona_Comercio</th>
                          <th scope="col">Tipo_Comercio</th>
                        </tr>
                      </thead>
                      <tbody id="tabla-minorista">          
                  ...
                  <div class="container-fluid">
                   <div class="row">
                    <div class="col-12">
                      <div class="card">
                        <div class="card-body">
                          <h5 class="card-title m-b-0">Informe Global</h5>
                        </div>
                        <table class="table-global">
                          <thead>
                            <tr>
                              ...
                              <th scope="col">Zona_Comercio</th>
                              <th scope="col">Tipo_Comercio</th>
                              <th scope="col"> PorcentajeyPago</th>
                            </tr>
                          </thead>
                          <tbody id="tabla-global">
