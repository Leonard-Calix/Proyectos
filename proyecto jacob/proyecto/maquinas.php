                                                ...
                                                <table id="userList" class="table table-bordered table-hover table-striped">
                                                    <thead class="thead-light">
                                                        <tr>
                                                            ...
                                                            <th scope="col">Cantidad Fallo</th>
                                                            <th></th>
                                                        </tr>
                                                    </thead>
                                        ...
                                        <div class="card-body">
                                            <form class="form" role="form" autocomplete="off">
                                                <div class="form-group row">
                                                    <label class="col-lg-3 col-form-label form-control-label">Nombre Maquina</label>
                                                    <div class="col-lg-9">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-3 col-form-label form-control-label">Cantidad de Fallo</label>
                                                    <div class="col-lg-9">
                                                        <input id="cantidadFallos" class="form-control" type="email">
                                                    </div>
                                                </div>
                      ...
                      <div class="modal-body">
                        <form class="form" role="form" autocomplete="off">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label form-control-label">Cantidad de Fallo</label>
                                <div class="col-lg-9">
                                    <input id="cantidadFallos2" class="form-control" type="email">
                                </div>
                            </div>
