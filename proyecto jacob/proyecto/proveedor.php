                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form class="form" role="form" autocomplete="off">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-3 col-form-label form-control-label">Tipo Proveedor</label>
                                                    <div class="col-lg-9">
                                                        <input id="tipo" class="form-control" type="text" >
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-3 col-form-label form-control-label">Tipo Pieza</label>
                                                    <div class="col-lg-9">
                                                        <input id="tipoP" class="form-control" type="email">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-3 col-form-label form-control-label">Estado Pieza</label>
                                                    <div class="col-lg-9">
                      ...
                      <div class="modal-body">
                        <form class="form" role="form" autocomplete="off">
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label form-control-label">Nombre Proveedor</label>
                                <div class="col-lg-9">
                                    <input id="nombre2" class="form-control" type="text" >
                            ...
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label form-control-label">Tipo Proveedor</label>
                                <div class="col-lg-9">
                                    <input id="tipo2" class="form-control" type="text" >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label form-control-label">Tipo Pieza</label>
                                <div class="col-lg-9">
                                    <input id="tipoP2" class="form-control" type="email">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label form-control-label">Estado Pieza</label>
                                <div class="col-lg-9">
                                    <input id="estado2" class="form-control" type="text">
                                </div>
                            </div>
