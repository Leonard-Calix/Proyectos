      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="well">
            ...
            <a class="btn-primary btn" href="reportes/huezpedes.php" target="_blank">Reporte</a>
          </div>
        </div>
        <div class="col-md-9">
          <!-- Website Overview -->
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-title">Huespedes</h3>
            </div>
...
*/
              ...
              <table class="table table-striped table-hover">                     
                ...
                <?php while( $huespedes = $conexion->obtenerFila($resultado) ){ ?>
                  <tr>
                    <td><?php echo $huespedes['PNOMBRE'] . " " . $huespedes['SNOMBRE'] ?></td>
                    <td><?php echo $huespedes['PAPPELLIDO'] . " " . $huespedes['SAPELLIDO'] ?></td>
                    <td><?php echo $huespedes['CORREO'] ?></td>
                    <td>
                        <a class="btn btn-default" href="editarUsuario.php?id=<?php echo $huespedes['IDCLIENTE'] ?>">Editar</a> 
                        <input class="btn btn-danger" type="button" value="eliminar" onclick="eliminarHuesped('<?php echo $huespedes['IDCLIENTE'] ?>');">
                    </td>
                  </tr>
                <?php } ?>
              </table>
              <a class="btn btn-primary" href="nuevoHuesped.php">Nuevo</a>
            </div>
          </div>
        </div>
      </div>
