...
$fpdf->SetY(15);
$fpdf->SetX(120);
$fpdf->Write(15, 'Personas Registradas');
/*$fpdf->Ln();
$fpdf->SetX(120);
...
$fpdf->Cell(60, 10, 'NOMBRE', 0, 0, 'C', 1);
$fpdf->Cell(60, 10, 'APLELLIDO', 0, 0, 'C', 1);
$fpdf->Cell(60, 10, 'CORREO', 0, 0, 'C', 1);
$fpdf->Ln();
...
while ( $facturas = $conexion->obtenerFila($resultado)  ) {
	...
	$fpdf->Cell(60, 10, $facturas["PNOMBRE"] . " ". $facturas["SNOMBRE"] , 0, 0, 'C', 1);
	$fpdf->Cell(60, 10, $facturas["PAPPELLIDO"] . " " . $facturas["SAPELLIDO"] , 0, 0, 'C', 1);
	$fpdf->Cell(60, 10, $facturas["CORREO"] , 0, 0, 'C', 1);
	$fpdf->Ln();
	$cantidad++;
}
$fpdf->OutPut();
