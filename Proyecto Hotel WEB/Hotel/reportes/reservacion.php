...
$sql = "SELECT * FROM Vista_RESERVACION";
...
$fpdf->Cell(35, 10, 'HUEZPED', 0, 0, 'C', 1);
$fpdf->Cell(35, 10, 'EMPLEADO', 0, 0, 'C', 1);
$fpdf->Cell(35, 10, 'ESTADO', 0, 0, 'C', 1);
$fpdf->Cell(35, 10, 'FECHA INGRESO', 0, 0, 'C', 1);
$fpdf->Cell(35, 10, 'FECHA SALIDA', 0, 0, 'C', 1);
$fpdf->Ln();
...
while ( $reservacion = $conexion->obtenerFila($resultado)  ) {
	...
	$fpdf->Cell(35, 10, $reservacion["HUEZPED"]  , 0, 0, 'C', 1);
	$fpdf->Cell(35, 10, $reservacion["EMPLEADO"]  , 0, 0, 'C', 1);
	$fpdf->Cell(35, 10, $reservacion["ESTADO"] , 0, 0, 'C', 1);
	$fpdf->Cell(35, 10, $reservacion["FECHAINGRESO"] , 0, 0, 'C', 1);
	$fpdf->Cell(35, 10, $reservacion["FECHASALIDA"] , 0, 0, 'C', 1);
	$fpdf->Ln();
	$fpdf->Ln();
	$cantidad++;
}
