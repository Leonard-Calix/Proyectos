                  ...
                  <div class="row">
                    <div class="col-xl-6 col-md-6 col-sm-12 col-12">
                      <div class="form-group ">
                        <label>ID de Reservacion</label>
                        <input  type="text" class="form-control" placeholder="" value="" id="reservacion" name="reservacion">
                      </div>
                      <div class="form-group">
                        <label>Cantidad</label>
                        <input name="cantidad" id="cantidad" type="text" class="form-control" placeholder="" value="">
                      </div>
                      <div class="col-md-3">
                        <br>
                        <button id="EnviarComida" class="btn btn-primary">Agregar</button>
