...
<body>
  ...
  $vista = "SELECT * FROM Vista_PLATILLOS";
  $resultado = $conexion->ejecutarConsulta($vista); 

  $emp = "SELECT * FROM Vista_EMPLEADOS";
  $empleados = $conexion->ejecutarConsulta($emp);

  $cli = "SELECT * FROM Vista_HUESPEDES";
  $clientes = $conexion->ejecutarConsulta($cli);
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="list-group">
            ...
            <a href="comprarBebida.php" class="list-group-item"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>Comprar Bebida<span class="badge">112</span></a>
          </div>
       ...
       <div class="col-md-9">
        ...
        <div class="panel panel-default">
          <div class="panel-heading main-color-bg">
            <h3 class="panel-title">Comprar Plato</h3>
          </div>
          <div class="panel-body">
            ...
            <table class="table table-striped table-hover">                     
              ...
              <?php while( $platillo = $conexion->obtenerFila($resultado) ){ ?>
                <tr>
                  <td><?php echo $platillo["NOMBRE"] ; ?></td>
                  <td><?php echo $platillo["PRECIO"] ; ?></td>
                  <td><?php echo $platillo["descripcion "] ; ?></td>
                  <td>
                    <a class="btn btn-default" href="pedido.php?id=<?php echo $platillo['IDPLATO'] ?>">Comprar</a> 
                    <a class="btn btn-danger" href="pedidoCliente.php?id=<?php echo $platillo['IDPLATO'] ?>">Servicio al cuarto</a> 
                    <!--input class="btn btn-danger" type="button" value="Servisio al cuarto" onclick="eliminarBebi('<?php echo $bebida["IDBEBIDAS"] ?>');"-->
                  </td>
                </tr>
              <?php } ?>
            </table>
