...
<body>
  ...
  <header id="header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-10">
          <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Comidas<small></small></h1>
        </div>
        <div class="col-md-2">
               ...
               <table class="table table-striped table-hover">                     
                ...
                <?php  while( $plato = $conexion->obtenerFila($resultado) ){ ?>
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-default" href="editarPlato.php?id=<?php echo $plato['IDPLATO'] ?>">Editar</a> 
                      <input class="btn btn-danger" type="button" value="eliminar" onclick="eliminarComi('<?php echo $plato['IDPLATO'] ?>');">
                    </td>
                  </tr>
                <?php } ?>
              </table>
              <a class="btn btn-primary" href="nuevoPlato.php">Nuevo</a>
            </div>
          </div>
        </div>
      </div>
