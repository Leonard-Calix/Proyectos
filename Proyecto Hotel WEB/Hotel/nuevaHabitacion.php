...
<body>
	...
	<section id="breadcrumb">
		<div class="container-fluid">
			<ol class="breadcrumb">
				<li><a href="index.php">Panel de Control</a></li>
				<li class="active">Habitacion / Nueva</li>
			</ol>
		</div>
	</section>
				...
				<div class="col-md-9">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-xl-6 col-md-6 col-sm-12 col-12">
									<div class="form-group">
										...
										<input id="no" name="no" type="text" class="form-control" placeholder="" value="">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label>Precio</label>
										<input id="precio" name="precio" type="text" class="form-control" placeholder="" value="">
									</div>
								</div>
								<div class="col-xl-6 col-md-6 col-sm-12 col-12">
									<div class="form-group">
							...
							<button id="guardarHab" class="btn btn-primary">Guardar</button>
