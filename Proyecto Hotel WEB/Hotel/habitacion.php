...
<body>
  ...
  <header id="header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-10">
          <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Habitaciones<small></small></h1>
        </div>
        <div class="col-md-2">
        ...
        <div class="col-md-9">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              $vista = "SELECT * FROM Vista_HABITACIONES";
/*
...
*/
              ...
              <table class="table table-striped table-hover">
                ...
                <?php  while( $habitacion = $conexion->obtenerFila($resultado) ){ ?>
                    <tr>
                      ...
                      <td><a class="btn btn-default" href="editarHab.php?id=<?php echo $habitacion['IDHABITACION'] ?>">Editar</a> 
                      <input class="btn btn-danger" type="button" value="eliminar" onclick="eliminarHab('<?php echo $habitacion['IDHABITACION'] ?>');">
                      </td>
                    </tr>
                     <?php } ?>
              </table>
              <a class="btn btn-primary" href="nuevaHabitacion.php">Nueva</a>
            </div>
          </div>
