...
<body>
	...
	<section id="breadcrumb">
		<div class="container-fluid">
			<ol class="breadcrumb">
				<li><a href="index.php">Panel de Control</a></li>
				<li class="active">Entradas / Nueva Entrada</li>
			</ol>
		</div>
	</section>
	...
	$sql = "SELECT * FROM categoria WHERE IDCATEGORIA < 11";
	$categoria = $conexion->ejecutarConsulta($sql);
	?>	
				...
				<div class="col-md-9">
					...
					<div class="panel panel-default">
						<div class="panel-heading main-color-bg">
							<h3 class="panel-title">Nueva Entrada</h3>
						</div>
							...
							<div class="row">
								<div class="col-xl-6 col-md-6 col-sm-12 col-12">
									<div class="form-group">
										<label>Nombre </label>
										<input name="nombre" id="nombre" type="text" class="form-control" placeholder="" value="">
									</div>
									<div class="form-group">
										<label>Precio Costo</label>
										<input name="precioc" id="precioc" type="text" class="form-control" placeholder="" value="">
									</div>
									<div class="form-group">
										<label>Precio Venta</label>
										<input name="preciov" id="preciov"  type="text" class="form-control" placeholder="" value="">
									</div>
									<div class="form-group">
										<label >Categoria Poducto</label>
										<select name="categoria" id="categoria" class="form-control">
											<?php while ($cat = $conexion->obtenerFila($categoria)) { ?>
								...
								<div class="col-xl-6 col-md-6 col-sm-12 col-12">
									...
									<div class="form-group">
										...
										<input id="cantidad" name="cantidad" type="text" class="form-control" placeholder="" value="">
									</div>

								</div>
							</div>
							<button id="GuardarEntrada" class="btn btn-primary">Guardar</button>
							<a class="btn btn-default" href="entradas.php">Cancelar</a>
						</div>
					</div>
