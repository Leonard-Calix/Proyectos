...
<body>
  ...
  <header id="header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-10">
          <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Reservaciones <small></small></h1>
        </div>
        <div class="col-md-2">
        ...
        <div class="col-md-3">
          ...
          <div class="well">
            ...
            <div class="progress">
              ...
              <a class="btn-primary btn" href="reportes/reservacion.php" target="_blank">Reporte</a>
          </div>
        </div>
        <div class="col-md-9">
          <!-- Website Overview -->
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-title">Reservacion</h3>
            </div>
...
/*
           ...
           */   
               ...
               <table class="table table-striped table-hover">
                ...
                <?php  while( $reservacion = $conexion->obtenerFila($resultado) ){ ?>
                  <tr>
                    <td> <?php echo $reservacion["HUEZPED"]; ?> </td>
                    <td> <?php echo $reservacion["EMPLEADO"]; ?> </td>
                    <td> <?php echo $reservacion["NUMERO"]; ?> </td>
                    <td> <?php echo $reservacion["ESTADO"]; ?> </td>
                    <td> <?php echo $reservacion["FECHAINGRESO"] ?> </td>
                    <td> <?php echo $reservacion["FECHASALIDA"] ?> </td>
                    <td> <a class="btn btn-warning" href="detalles.php?id=<?php echo $reservacion['IDRESERVACION'] ?>"> Detalles</a></td>
                  </tr>
                <?php } ?>
              </table>
            </div>
