      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <?php 
            ...
            $sql = "SELECT * FROM bebidas b
                    INNER JOIN tipobebida tb ON tb.idtipobebida=b.tipobebida
                    WHERE idbebidas = $id";
        ...
        <div class="col-md-9">
          ...
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-title">Editar Bebida <?php echo $_GET["id"]; ?> </h3> 
            </div>
                 ...
                 <div class="row">
                  ...
                  <div class="col-xl-6 col-md-6 col-sm-12 col-12">
                   <div class="form-group">
                    ...
                    <input name="nombre" id="nombre" type="text" class="form-control" placeholder="" value="<?php echo $bebida ["DESCRIPCION"] ?>">
                  </div>
                  <div class="form-group">
                    <label>Valor</label>
                    <input name="valor" id="valor" type="text" class="form-control" placeholder="" value="<?php echo $bebida ["PRECIO"] ?>"">
                  </div>
                  <div class="form-group">
                  ...
                  <button id="editarBebida" class="btn btn-primary">Guardar Cambios</button>
