            ...
            <div class="panel-body">
                <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <input id="pnombre" name="pnombre" type="text" class="form-control" placeholder="" value="">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input id="papellido"  name="papellido"  type="text" class="form-control" placeholder="" value="">
                  </div>
                  <div class="form-group">
             ...
             <button id="btnNuevoEmpleado" class="btn btn-primary">Guardar</button>
