...
<body>
    ...
    <div class="container-fluid">
      ...
      <div style="padding-top: 10px; padding-bottom: 10px;" id="navbar" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
          ...
          <li><a href="paginas.php">Reservaciones</a></li>
  ...
  <header id="header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-10">
          <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Entradas<small></small></h1>
        </div>
        <div class="col-md-2">
  ...
  $vista = "SELECT * FROM  VISTA_PRODUCTOSE ";
  $resultado = $conexion->ejecutarConsulta($vista); 
          /*
        while( $entradas = $conexion->obtenerFila($resultado) ){
           echo "<pre>";
           var_dump($entradas);
           echo "</pre>";
         }
              ...
              <div class="col-md-9">
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-md-12">
                        <input class="form-control" type="text" placeholder="Filtrar entradas...">
                      </div>
                    </div>
                    <br>
                    <table class="table table-striped table-hover">
                      ...
                      <?php while( $entradas = $conexion->obtenerFila($resultado) ){ ?>
                      <tr>
                        <td><?php echo $entradas["NOMBRE"] ?></td>
                        <td><?php echo $entradas["DESCRIPCION"] ?></td>
                        <td><?php echo $entradas["PRECIOCOSTO"] ?></td>
                        <td><?php echo $entradas["CANTIDAD"] ?></td>
                        <td><?php echo $entradas["COSTO"] ?></td>
                        <td><?php echo $entradas["FECHA"] ?></td>
                        <td><a class="btn btn-danger" onclick="eliminarEntrada( <?php echo "string"; ?> );" href="#">Borrar</a></td>
                      </tr>
                    <?php } ?>
                    </table>
                    <a class="btn btn-primary" href="nuevaEntrada.php">Agregar</a>
                  </div>
                </div>
