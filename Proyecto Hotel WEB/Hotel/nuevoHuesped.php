...
<body>
	...
	<header id="header">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-10">
					<h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Entradas<small> Nuevo Empleado</small></h1>
				</div>
				<div class="col-md-2">
	...
	<section id="breadcrumb">
		<div class="container-fluid">
			<ol class="breadcrumb">
				<li><a href="index.php">Panel de Control</a></li>
				<li class="active">Empleados / Nuevo</li>
			</ol>
		</div>
	</section>
				...
				<div class="col-md-9">
					...
					<div class="panel panel-default">
						<div class="panel-heading main-color-bg">
							<h3 class="panel-title">Nuevo Huesped</h3>
						</div>
							...
							<div class="row">
								<div class="col-xl-6 col-md-6 col-sm-12 col-12">
									<div class="form-group">
										...
										<input id="pnombre" name="pnombre" type="text" class="form-control" title="Obligatorio" required >
									</div>
									<div class="form-group">
										<label>Segundo Nombre</label>
										<input id="snombre" name="snombre"  type="text" class="form-control" placeholder="" value="">
									</div>
									<div class="form-group">
										<label>Primer Apellido</label>
										<input id="papellido" name="sapellido" type="text" class="form-control" placeholder="" value="">
									</div>
									<div class="form-group">
										<label>Segundo Apellido</label>
										<input id="sapellido" name="sapellido" type="text" class="form-control" placeholder="" value="">
									</div>
								</div>
								<div class="col-xl-6 col-md-6 col-sm-12 col-12"> 
									<div class="form-group">
										<label>Numero</label>
										<input id="telefono" name="telefono" type="text" class="form-control" placeholder="" value="">
									</div>
									<div class="form-group">
										<label>Correo</label>
										<input id="correo" name="correo" type="email" class="form-control" placeholder="" value="">
									</div>
									<div class="form-group">
										<label>direccion</label>
										<input id="direccion" name="direccion" type="text" class="form-control" placeholder="" value="">
									</div>
								</div>
							</div>
							<input type="hidden" id="id" name="id" value="1">
							<button  id="guardarH" class="btn btn-primary" >Guardar</button>
							<a class="btn btn-default" href="huespedes.php">Cancelar</a>
						</div>
					</div>
				</div>
			</div>
