 ...
 <nav class="navbar navbar-default">
  ...
  <header id="header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-10">
          <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Comidas<small> Nuevo Plato</small></h1>
        </div>
        <div class="col-md-2">
  ...
  <section id="breadcrumb">
    <div class="container-fluid">
      <ol class="breadcrumb">
        <li><a href="index.php">Panel de Control</a></li>
        <li class="active">Comidas / Nuevo Plato</li>
      </ol>
    </div>
  </section>
        ...
        <div class="col-md-9">
          ...
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-title">Nuevo Plato</h3>
            </div>
                ...
                <div class="row">
                  ...
                  <div class="col-xl-6 col-md-6 col-sm-12 col-12">
                   <div class="form-group">
                    ...
                    <input id="nombre" name="nombre" type="text" class="form-control" required="Campo requerido" >
                  </div>
                  <div class="form-group">
                    <label>Valor</label>
                  ...
                  <button id="GuardarPlatillo" class="btn btn-primary">Guardar</button>
                  <a class="btn btn-default" href="Comidas.php">Canselar</a>
