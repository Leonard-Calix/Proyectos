...
<body>l
  ...
  <header id="header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-10">
          <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>Editar Plato<small></small></h1>
        </div>
        <div class="col-md-2">
  ...
  <section id="breadcrumb">
    <div class="container-fluid">
      <ol class="breadcrumb">
        <li><a href="index.php">Panel de Control</a></li>
        <li class="active">Editar / Comida</li>
      </ol>
    </div>
  </section>
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <?php 
            ...
            $sql = "SELECT * FROM platos p
                    INNER JOIN tipoplato tp ON p.idtipoplato=tp.idtipoplato
                    WHERE idplato = $id";

            $resultado = $conexion->ejecutarConsulta($sql);
           /* 
            while ($plato = $conexion->obtenerFila($resultado) ) {
              echo "<pre>";
                  var_dump($plato);
              echo "</pre>";
        ...
        <div class="col-md-9">
          ...
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-title">Editar Comida <?php echo $id ?> </h3> 
            </div>
            ...
            <div class="panel-body">
                 <div class="row">
                  ...
                  <div class="col-xl-6 col-md-6 col-sm-12 col-12">
                   <div class="form-group">
                    ...
                    <input name="nombre" id="nombre" type="text" class="form-control" placeholder="" value=" <?php  echo $plato["NOMBRE"] ?>">
                  </div>
                  <div class="form-group">
                    <label>Valor</label>
                    <input name="valor" id="valor" type="text" class="form-control" placeholder="" value=" <?php echo $plato["PRECIO"] ?>">
                  </div>
                  <div class="form-group">
              ...
              <?php } ?>
                  ...
                  <button id="editarPlato" class="btn btn-primary">Guardar Cambios</button>
                   <a class="btn btn-default" href="Comidas.php">Cancelar</a> 
                </div>
              </div>
          </div>
        </div>
