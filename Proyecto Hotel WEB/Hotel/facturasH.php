    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-3">
          ...
          <a class="btn btn-success" href="reportes/facturaHotel.php" target="_blank"  >Generar Reporte</a>
        </div>
        <div class="col-md-9">
          <!-- Website Overview -->
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-title">Facturas del Hotel</h3>
            </div>
            <div class="panel-body">
              ...
              $sql = "SELECT * FROM VW_DETALLE_FACTURA_RESERVACION ORDER BY IDRESERVACION ASC";
              ...
              ?>
               ...
               <table class="table table-striped table-hover">                     
                ...
                <tr> 
                  ...
                  <td> <?php echo $factura["DESCRIPCIONHABITACION"];  ?> </td>
                  <td> <?php echo $factura["PRECIOHABITACION"];  ?> </td>
                  <td> <?php echo $factura["ESTADIA"];  ?> </td>
                  <td> <?php echo $factura["TOTALHABITACION"];  ?> </td>
                  <td> <?php echo $factura["COSTOPEDIDO"];  ?> </td>
