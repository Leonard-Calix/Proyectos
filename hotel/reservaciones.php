				...
				<div class="containter">
					<div class="card">	
						<div class="card-body">	
							...
							<h2>Reservaciones</h2> 
							<h5 class="card-title">Reservaciones actuales</h5>
							<!-- Tabla --> 
								<br />  
							...
							<!--- input --->
							  ...
							  <div class="form-group">
								...
								<div class="form-group">
									...
									<input type="number" class="form-control" pattern= "[0-9]" min='0' max='4' id="Num_P" placeholder="1">
									
									<input type="hidden" id="var1" name="custId" value="1">
									<input type="hidden" id="var2" name="custId" value="1">
									<input type="hidden" id="var3" name="custId" value="1">
									<input type="hidden" id="var4" name="custId" value="1">
									<input type="hidden" id="var5" name="custId" value="1">
								</div>
